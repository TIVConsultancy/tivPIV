 ...
 */
public class Prot_PIVRead2IMGFiles2 extends PIVProtocol {

    File imgFile;
    File imgFile2;
    ImageInt imgRead;
    ImageInt imgRead2;
    private String name = "Read In 2";
    
    public Prot_PIVRead2IMGFiles2(String name) {
        this();
        this.name = name;
    }
    
    public Prot_PIVRead2IMGFiles2() {
        super();
    ...
    public void buildClusters() {
        ...
        SettingsCluster Test = new SettingsCluster("ClusterTest",
                                                       new String[]{"Test1", "Test2"}, this);
        CutImage.setDescription("Test 1");
    ...
    private void initSettings(){
        ...
        this.loSettings.add(new SettingObject("Test1","Test1", 10, SettingObject.SettingsType.String));
        this.loSettings.add(new SettingObject("Test2","Test2", 10, SettingObject.SettingsType.String));
    }
