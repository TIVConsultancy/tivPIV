 ...
 */
public class DialogSQLtoPic extends Dialog<Map<Enum, String>> {

    private ComboBox combExperiments;
    private ButtonType processButton = new ButtonType("Load", ButtonBar.ButtonData.OK_DONE);

    public DialogSQLtoPic() {
