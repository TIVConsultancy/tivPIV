...
public class Main extends Application {
    ...
    public static void showEmptyMainFrame(Stage primaryStage) throws IOException {
        ...
        primaryStage.show();
         StaticReferences.controller.startNewSession(new File("E:\\Sync\\TIVConsultancy\\_Customers\\HZDR\\DataProject\\FolderHZDRDataManagement\\Examples-2020-3-30 20.46.28\\NabilLongColumn\\Water\\1p0"));
